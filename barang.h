...
int data();
int hemat,menu,pil1,pil2,pil5,pilcocktail,pilcoffee,pilgulai,pilIga,pilmenu,pilayce,pilpaket,pilappetizer,pilmcourse,pildessert,pilbeverages,subtotal,pembayaran,point,diskonpersen;
