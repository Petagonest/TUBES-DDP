...
int data(){
    ...
    do{
		...
		do{
	    	...
	    	if(flag == 0){		//--------------------------------------------------------====> MEMASUKKAN DATA KE STRUK (mulai)
				input_struk();
				...
				if(qtyappetizer > 0){
			        ...
			        if (totalappetizer >=100000 && totalappetizer < 1000000){
			        	fprintf(fpointer,"\t     %d\n",totalappetizer);}
			        else if(totalappetizer < 100000 ){
						fprintf(fpointer,"\t     %d\n",totalappetizer);}
					else if(totalappetizer >= 1000000){
						fprintf(fpointer,"\t    %d\n",totalappetizer);}    
			        flag++;
			        fclose(fpointer);
					fileqtyappetizer=qtyappetizer;
					}
				if(qtymcourse > 0){
			        ...
			        if (totalayce >=100000 && totalayce < 1000000){
			        	fprintf(fpointer,"\t     %d\n",totalayce);}
			        else if(totalayce < 100000 ){
						fprintf(fpointer,"\t     %d\n",totalayce);}
					else if(totalayce >= 1000000){
						fprintf(fpointer,"\t    %d\n",totalayce);}  
			        flag++;
			        fclose(fpointer);
					fileqtymcourse=qtymcourse;
					}
			    if(qtydessert > 0){
				...
				if(qtyayce > 0){
					...
					update_to_file_ayce(ayce->nama,kuantitasayce,totayce);
					fileqtyayce=0;
			}
				if(qtypaket > 0){
				
					update_to_file_paket(paket->nama,kuantitaspaket,totpaket);
			}
